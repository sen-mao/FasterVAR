...
if __name__ == '__main__':
    ...
    parser.add_argument('--metadata_file', type=str, default='Infinity/evaluation/gen_eval/prompts/evaluation_metadata.jsonl')
    ...
    parser.add_argument('--sv_percent', type=str, default=None)
    ...
    for index, metadata in enumerate(metadatas):
        ...
        for sample_j in range(args.n_samples):
            ...
            if args.model_type == 'flux_1_dev':
                ...
                image = gen_one_img(infinity, vae, text_tokenizer, text_encoder, prompt, tau_list=tau, cfg_sc=3, cfg_list=cfg, scale_schedule=scale_schedule, cfg_insertion_layer=[args.cfg_insertion_layer], vae_type=args.vae_type, sv_percent=args.sv_percent)
            else:
                raise ValueError
            t2 = time.time()
