...
test_gen_eval() {
    ...
    # detect objects
    # https://github.com/djghosh13/geneval/blob/main/evaluation/download_models.sh
    ...
    --model-path Infinity/weights/mask2former
...
infinity_model_path=/data/FoundationVision/Infinity/infinity_2b_reg.pth
