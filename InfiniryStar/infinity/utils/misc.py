...
class MetricLogger(object):
    ...
    def log_every(self, start_it, max_iters, itrt, log_freq, log_every_iter=False, header='', args=None):    # also solve logging & skipping iterations before start_it
        ...
        if isinstance(itrt, Iterator) and not hasattr(itrt, 'preload') and not hasattr(itrt, 'set_epoch'): # this
            for it in range(start_it, max_iters):
                ...
                if args is not None and args.twoclip_alternatingtraining:  # 2 clips alternating training
