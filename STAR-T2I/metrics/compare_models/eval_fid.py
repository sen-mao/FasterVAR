...
def prepare_images(savedir_pred,savedir_gt, gen_reso=256, depth=30,batch_sz=8):
    # 一些参数
    select_sz=batch_sz
    ...
    if gen_reso==256:
        ...
        if depth==16:
            # var_ckpt='/home/nfs/nfs-40/maxiaoxiao/workspace/var_rope_d16/ar-ckpt-ep15-iter0.pth'
            # var_ckpt='/home/nfs/nfs-141/maxiaoxiao/workspace/var_rope_d16_theta_modified_anorm/ar-ckpt-ep7-iter0.pth'
            var_ckpt='/home/nfs/nfs-142/maxiaoxiao/workspace/var_rope_d16_theta_ab_rope/ar-ckpt-ep6-iter20000.pth'
            # var_ckpt='/home/nfs/nfs-142/maxiaoxiao/workspace/var_rope_d16_theta_ab_rope2/ar-ckpt-ep6-iter10000.pth'
        else:
            var_ckpt='/home/nfs/nfs-142/maxiaoxiao/workspace/var_rope_d30_256_stage2/ar-ckpt-ep3-iter10000.pth'
            var_ckpt='/home/nfs/nfs-132/liangtao/workspace/star/var_rope_d30_256/ar-ckpt-ep3-iter10000.pth'
            var_ckpt='/home/nfs/nfs-132/liangtao/workspace/star/var_rope_d30_256-1219/ar-ckpt-ep1-iter20000.pth'
            #var_ckpt='/home/nfs/nfs-142/maxiaoxiao/workspace/var_rope_d30_256_stage2/ar-ckpt-ep3-iter0.pth'
            # var_ckpt='/home/nfs/nfs-40/maxiaoxiao/workspace/var_rope_d30_debug/ar-ckpt-ep19-iter0.pth'
        enable_logit_norm=True
    elif gen_reso==512:
        patch_nums =[1, 2, 3, 4, 6, 9, 13, 18, 24, 32]
        var_ckpt='/home/nfs/nfs-142/maxiaoxiao/workspace/var_rope_d30_512/ar-ckpt-ep2-iter30000.pth'
        var_ckpt='/home/nfs/nfs-132/liangtao/workspace/star/var_rope_d30_512/ar-ckpt-ep2-iter30000.pth'
        enable_logit_norm=True
    elif gen_reso==1024:
        patch_nums =[1, 2, 3, 4, 5, 7, 9, 12, 16, 21, 27, 36, 48, 64]
        patch_nums =[1, 2, 3, 4, 5, 6, 8, 10, 13, 16, 24, 32, 48, 64]
        # byte 1024=[1, 2, 4, 6, 8, 12,16, 20, 24, 32, 40, 48, 64]
    ...
    if sample_version == 'old':
        vae_local, var_wo_ddp = build_vae_var(
            ...
            depth=depth, shared_aln=False, attn_l2_norm=False,
            enable_cross=True,
            ...
            with torch.inference_mode():
                ...
                with torch.autocast('cuda', enabled=True, dtype=torch.float16, cache_enabled=True):    # using bfloat16 can be faster
                    recon_B3HW = var_wo_ddp.autoregressive_infer_cfg(B=B_, label_B=None, 
                                                                    ...
                                                                    more_smooth=False,
                                                                    w_mask=False, sample_version=sample_version)
...
if __name__=="__main__":
    ...
    parser.add_argument('--save_root', type=str, default='/home/nfs/nfs-132/star/eval_results/var_rope_retrain1219/d30-256_FID_mjhq_ep1_20000', help='Path to save results')
    parser.add_argument('--gen_reso', type=int, default=256, help='Image resolution')
    parser.add_argument('--batch_sz', type=int, default=8, help='Image resolution')
    args = parser.parse_args()
    savedir_pred=osp.join(args.save_root,'prediction')
    savedir_gt=osp.join(args.save_root,'reference')

    prepare_images(savedir_pred=savedir_pred,savedir_gt=savedir_gt,gen_reso=args.gen_reso,depth=args.depth,batch_sz=args.batch_sz)
