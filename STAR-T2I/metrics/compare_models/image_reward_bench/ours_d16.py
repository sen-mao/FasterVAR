...
def prepare_images(savedir_pred,sample_per_batch=10):
    ...
    var_ckpt='/home/disk2/mxx/workspace/var_rope_ablations_d16/ab_cross_ep13_iter0.pth'
    ...
    vae_local, var_wo_ddp = build_vae_var(
        ...
        enable_cross=False,in_dim_cross=1024,#TODO:换成从text enc得到的参数
...
if __name__=="__main__":
    save_root='/home/disk2/mxx/workspace/var_rope_d16_ab_256/image_reward_bench'
    savedir_pred=osp.join(save_root,'var_ab_cross_2')
